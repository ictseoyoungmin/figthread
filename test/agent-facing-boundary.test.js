...
const publicContractVersionLabel = /\b(?:FigureSpec|VisualSpec|PrimitiveDefinition|PrimitivePlan|MotionSpec|LayoutIntent|ResolvedLayout|LayoutRequest|LayoutTarget|MotionProgram)\s+v?\d+\.\d+\b/g;
