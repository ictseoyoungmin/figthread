...
const publicContractVersionLabel = /\b(?:FigureSpec|GrammarDefinition|GrammarPlan|VisualSpec|PrimitiveDefinition|PrimitivePlan|ProfilePlan|MotionSpec|LayoutIntent|ResolvedLayout|LayoutRequest|LayoutTarget|MotionProgram|RenderedSvg)\s+v?\d+\.\d+\b/g;
